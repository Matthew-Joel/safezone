				...
				<div className="grid mt-20 gap-20">
					<div className="grid lg:flex lg:flex-row mx-5 lg:mx-20 lg:space-x-14">
						...
						<div className="flex flex-col gap-3 justify-center mx-18">
							...
							<p className="text-sm">
								...
								have the ability to cancel it at any time. However, this can only be
								done when both parties agree that the transaction is invalid. We
								prioritize your safety and satisfaction throughout the entire
								transaction process.
							</p>
							<p className="text-sm">
								Also, we give peace of mind for buyers and confidence that their payment
								will be processed securely and efficiently. This can help to reduce
								anxiety and stress, allowing you as a buyer to focus on enjoying the
								purchasing process and the products or services you are buying.
							</p>
					...
					<div className="flex flex-col flex-col-reverse lg:flex lg:flex-row justify-center items-center mx-5 lg:mx-20 lg:space-x-8">
						<div className="flex flex-col gap-3 justify-center mx-18">
							...
							<p className="text-sm">
								...
								sellers can verify the authenticity of the payment and ensure that it is
								legitimate before shipping the product or delivering the service.
							</p>
							<p className="text-sm">
							...
							<p className="text-sm">
								We are creating a platform that help to build trust between you and your
								customer, which is essential for building a successful e-commerce
					...
					<div className="grid lg:flex lg:flex-row mx-5 lg:mx-20 lg:space-x-8">
						...
						<div className="flex flex-col gap-4 justify-center mx-18">
							...
							<p className="text-sm">
								<span className="font-bold">For E-Commerce Platform,</span> by utilizing
								...
								ensures that all transactions carried out on your website or app are
								safe and secure, which in turn builds trust among users. As a result,
								you can attract more users to your platform and increase user adoption.
							</p>
							<p className="text-[#00CCFF] cursor-pointer decoration hover:underline duration-300">
								Get Started {">>>"}
							</p>
