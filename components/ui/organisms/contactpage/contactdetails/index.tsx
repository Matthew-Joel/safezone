	...
	return (
		<div className="">
			<div className="flex items-center justify-center my-32 ">
				<div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-center lg:text-start mx-5 md:mx-32 gap-10 items-center">
					<div className="pt-4 justify-center md:justify-center md:items-center ml-0 md:ml-2">
					...
					<div className="justify-center md:justify-center md:items-center ml-2 md:ml-20 ">
					...
					<div className="justify-center md:justify-center md:items-center -ml-2 md:ml-14 border-black ">
