...
const ButWhy = () => {
    return (
        <div className="bg-white relative my-28 mx-12">
            <div className="flex flex-col items-center justify-center">
                <p className="text-4xl font-medium text-center">But why safezone?</p>
                <p className="text-sm md:w-[42%] text-center">Buying and selling online can be risky, but with SafeZone, 
                    you can be confident that your money is safe until you receive
                     the goods, products or services you ordered.
                </p>
            </div>
            <div>
