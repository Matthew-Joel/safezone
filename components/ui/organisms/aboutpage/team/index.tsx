				...
				<div className="justify-center my-5">
					...
					<div className="flex flex-col gap-20 md:flex-row md:gap-20 justify-center items-center text-center box-border">
						<div className="text-[#fff]">
							<img src="/images/Person1.png" alt="Darey Oloye" className="gradient-bg border-bg pb-2 pl-2" />
							<h2 className="font-bold text-xl mt-5">Darey Oloye</h2>
							<p className="text-sm">Founder and CEO</p>
							<div className="flex justify-center items-center">
							<img
								src="./logos/Linkedin.png"
								alt="Linkedin" className="mt-1"/>
							</div>
						</div>
						<div className="text-[#fff] text-sm">
							<img src="/images/Person2.png" alt="Ayo Jerry" className="gradient-bg border-bg pb-2 pl-2"/>
						...
						<div className="text-[#fff] text-sm">
							<img src="/images/Person3.png" alt="Damilola Onoshi" className="gradient-bg border-bg pb-2 pl-2" />
